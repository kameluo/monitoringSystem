...
def startButtonFunction():
    ...
    startingTestTime=datetime.datetime.now()
    ...
    if(checkBoxAnswerFileName.get()==1):
        ...
        worksheet1.write(0,5,"Power Density")
        #workbook.close()
    GPIO.setmode(GPIO.BCM)
    GPIO.setup(13,GPIO.OUT)
    GPIO.setwarnings(False)
    GPIO.output(13,GPIO.HIGH)
    while (datetime.datetime.now() - startingTestTime).seconds < testDuration:
